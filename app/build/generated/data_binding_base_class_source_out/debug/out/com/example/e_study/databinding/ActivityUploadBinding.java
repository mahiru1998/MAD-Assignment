...
public final class ActivityUploadBinding implements ViewBinding {
  ...
  private ActivityUploadBinding(@NonNull ConstraintLayout rootView, @NonNull EditText Name,
      @NonNull Button button21, @NonNull EditText email, @NonNull ImageButton imageButton,
  ...
  public static ActivityUploadBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUploadBinding((ConstraintLayout) rootView, Name, button21, email,
